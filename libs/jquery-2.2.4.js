...
// Fix IE bugs, see support tests
    ...
    function domManip( collection, args, callback, ignored ) {
        ...
        if ( l ) {
            ...
            // Require either css_v1.0.1 content or an interest in ignored elements to invoke the callback
            if ( first || ignored ) {
    ...
    jQuery.fn.extend( {
        ...
        replaceWith: function() {
            ...
            // Make the changes, replacing each non-ignored context element with the css_v1.0.1 content
            return domManip( this, arguments, function( elem ) {
